...
//CITY
        ...
        /*city& city::operator=(const city& other){
            ...
            // copying indexes and cities of other into my path
...
//PATH
        ...
        /*path& path::operator=(const path& other){
            ...
            for(int i=0; i<this->m_N; i++){
                this->m_indexes[i] = other.GetIndex(i);
                this->m_seq[i] = other.GetCity(i);
            }
            return *this;
        }*/
...
//POPULATION
        ...
        /*population& population::operator=(const population& other){
            ...
            for(int i=0; i<this->m_M; i++){
                this->m_paths[i] = other.GetPath(i);
            }
            return *this;
        }*/
        ...
        void population::Crossover(path mum, path dad, int ison, int idaughter, Random& rnd){
            ...
            //cout << endl << "index crossover: " << cut_index << endl;
